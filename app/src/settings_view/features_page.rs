...
cfg_if::cfg_if! {
    if #[cfg(target_os = "macos")] {
        fn extra_meta_keys_left_text() -> &'static str {
            crate::menu_label("settings.features.left_option_meta", "Left Option key is Meta")
        }
        fn extra_meta_keys_right_text() -> &'static str {
            crate::menu_label("settings.features.right_option_meta", "Right Option key is Meta")
        }
    } else {
        fn extra_meta_keys_left_text() -> &'static str {
            crate::menu_label("settings.features.left_alt_meta", "Left Alt key is Meta")
        }
        fn extra_meta_keys_right_text() -> &'static str {
            crate::menu_label("settings.features.right_alt_meta", "Right Alt key is Meta")
        }
    }
}
...
pub fn init_actions_from_parent_view<T: Action + Clone>(
    ...
    let mut toggle_binding_pairs = vec![
        ToggleSettingActionPair::new(
            crate::menu_label(
                "settings.features.toggle.copy_on_select",
        ...
        ToggleSettingActionPair::new(
            crate::menu_label(
                "settings.features.toggle.linux_selection_clipboard",
        ...
        ToggleSettingActionPair::new(
            crate::menu_label(
                "settings.features.toggle.autocomplete_symbols",
        ...
        ToggleSettingActionPair::new(
            crate::menu_label(
                "settings.features.toggle.restore_session",
        ...
        ToggleSettingActionPair::new(
            crate::menu_label(
                "settings.features.toggle.scroll_reporting",
                "scroll reporting",
            ),
            builder(SettingsAction::FeaturesPageToggle(
        ...
        ToggleSettingActionPair::new(
            crate::menu_label(
                "settings.features.toggle.completions_while_typing",
        ...
        ToggleSettingActionPair::new(
            crate::menu_label(
                "settings.features.toggle.command_corrections",
                "command corrections",
            ),
            builder(SettingsAction::FeaturesPageToggle(
        ...
        ToggleSettingActionPair::new(
            crate::menu_label(
                "settings.features.toggle.error_underlining",
                "error underlining",
            ),
            builder(SettingsAction::FeaturesPageToggle(
        ...
        ToggleSettingActionPair::new(
            crate::menu_label(
                "settings.features.toggle.syntax_highlighting",
                "syntax highlighting",
            ),
            builder(SettingsAction::FeaturesPageToggle(
        ...
        ToggleSettingActionPair::new(
            crate::menu_label(
                "settings.features.toggle.audible_bell",
        ...
        ToggleSettingActionPair::new(
            crate::menu_label(
                "settings.features.toggle.autosuggestions",
                "autosuggestions",
            ),
            builder(SettingsAction::FeaturesPageToggle(
        ...
        ToggleSettingActionPair::new(
            crate::menu_label(
                "settings.features.toggle.autosuggestion_keybinding_hint",
        ...
        ToggleSettingActionPair::new(
            crate::menu_label(
                "settings.features.toggle.autosuggestion_ignore_button",
    ...
    toggle_binding_pairs.push(ToggleSettingActionPair::new(
        crate::menu_label(
            "settings.features.toggle.ssh_reuse_control_master",
    ...
    toggle_binding_pairs.push(ToggleSettingActionPair::new(
        crate::menu_label(
            "settings.features.toggle.link_tooltip",
    ...
    toggle_binding_pairs.push(
        ToggleSettingActionPair::new(
            crate::menu_label(
                "settings.features.toggle.long_running_notifications",
    ...
    toggle_binding_pairs.push(
        ToggleSettingActionPair::new(
            crate::menu_label(
                "settings.features.toggle.agent_task_completed_notifications",
    ...
    toggle_binding_pairs.push(
        ToggleSettingActionPair::new(
            crate::menu_label(
                "settings.features.toggle.needs_attention_notifications",
    ...
    toggle_binding_pairs.push(
        ToggleSettingActionPair::new(
            crate::menu_label(
                "settings.features.toggle.notification_sounds",
                "notification sounds",
            ),
            builder(SettingsAction::FeaturesPageToggle(
    ...
    toggle_binding_pairs.push(
        ToggleSettingActionPair::new(
            crate::menu_label(
                "settings.features.toggle.in_app_agent_notifications",
    ...
    toggle_binding_pairs.push(
        ToggleSettingActionPair::new(
            crate::menu_label(
                "settings.features.toggle.quit_warning_modal",
                "quit warning modal",
            ),
            builder(SettingsAction::FeaturesPageToggle(
    ...
    toggle_binding_pairs.push(
        ToggleSettingActionPair::new(
            crate::menu_label(
                "settings.features.toggle.mouse_reporting",
                "mouse reporting",
            ),
            builder(SettingsAction::FeaturesPageToggle(
    ...
    toggle_binding_pairs.push(
        ToggleSettingActionPair::new(
            crate::menu_label(
                "settings.features.toggle.alias_expansion",
                "alias expansion",
            ),
            builder(SettingsAction::FeaturesPageToggle(
    ...
    toggle_binding_pairs.push(
        ToggleSettingActionPair::new(
            crate::menu_label(
                "settings.features.toggle.middle_click_paste",
                "middle-click paste",
            ),
            builder(SettingsAction::FeaturesPageToggle(
    ...
    toggle_binding_pairs.push(
        ToggleSettingActionPair::new(
            crate::menu_label(
                "settings.features.toggle.code_as_default_editor",
    ...
    toggle_binding_pairs.push(
        ToggleSettingActionPair::new(
            crate::menu_label(
                "settings.features.toggle.input_hint_text",
                "input hint text",
            ),
            builder(SettingsAction::FeaturesPageToggle(
    ...
    toggle_binding_pairs.push(
        ToggleSettingActionPair::new(
            crate::menu_label(
                "settings.features.toggle.vim_keybindings",
    ...
    toggle_binding_pairs.push(
        ToggleSettingActionPair::new(
            crate::menu_label(
                "settings.features.toggle.vim_unnamed_register",
    ...
    toggle_binding_pairs.push(
        ToggleSettingActionPair::new(
            crate::menu_label("settings.features.toggle.vim_status_bar", "Vim status bar"),
            builder(SettingsAction::FeaturesPageToggle(
    ...
    toggle_binding_pairs.push(
        ToggleSettingActionPair::new(
            crate::menu_label(
                "settings.features.toggle.focus_reporting",
                "focus reporting",
            ),
            builder(SettingsAction::FeaturesPageToggle(
    ...
    toggle_binding_pairs.push(ToggleSettingActionPair::new(
        crate::menu_label("settings.features.toggle.smart_select", "smart select"),
        builder(SettingsAction::FeaturesPageToggle(
    ...
    if FeatureFlag::AgentView.is_enabled() && AISettings::as_ref(app).is_any_ai_enabled(app) {
        toggle_binding_pairs.push(
            ToggleSettingActionPair::new(
                crate::menu_label(
                    "settings.features.toggle.help_block_in_new_sessions",
    ...
    toggle_binding_pairs.push(
        ToggleSettingActionPair::new(
            crate::menu_label(
                "settings.features.toggle.terminal_input_message_line",
    ...
    toggle_binding_pairs.push(
        ToggleSettingActionPair::new(
            crate::menu_label(
                "settings.features.toggle.at_context_menu_terminal",
    ...
    toggle_binding_pairs.push(ToggleSettingActionPair::new(
        crate::menu_label(
            "settings.features.toggle.preserve_input_focus_on_block_selection",
    ...
    if FeatureFlag::AgentView.is_enabled() && AISettings::as_ref(app).is_any_ai_enabled(app) {
        toggle_binding_pairs.push(
            ToggleSettingActionPair::new(
                crate::menu_label(
                    "settings.features.toggle.slash_commands_terminal",
    ...
    if FeatureFlag::AIContextMenuCode.is_enabled() {
        toggle_binding_pairs.push(
            ToggleSettingActionPair::new(
                crate::menu_label(
                    "settings.features.toggle.outline_codebase_symbols",
    ...
    toggle_binding_pairs.push(
        ToggleSettingActionPair::new(
            crate::menu_label(
                "settings.features.toggle.global_workflows_search",
    ...
    if GPUState::as_ref(app).is_low_power_gpu_available() {
        toggle_binding_pairs.push(
            ToggleSettingActionPair::new(
                crate::menu_label(
                    "settings.features.toggle.integrated_gpu",
    ...
    #[cfg(any(target_os = "linux", target_os = "freebsd"))]
    {
        if windowing_system_is_customizable(app) {
            toggle_binding_pairs.push(
                ToggleSettingActionPair::new(
                    crate::menu_label(
                        "settings.features.toggle.wayland_window_management",
    ...
    app.register_fixed_bindings([FixedBinding::empty(
        crate::menu_label(
            "settings.features.configure_global_hotkey",
    ...
    if DefaultTerminal::can_warp_become_default() {
        app.register_fixed_bindings([FixedBinding::empty(
            crate::menu_label(
                "settings.features.make_default_terminal",
...
fn block_maximum_rows_description() -> String {
    let max_rows = if ChannelState::enable_debug_features() {
        crate::menu_label("settings.features.ten_million", "10 million")
    } else {
        crate::menu_label("settings.features.one_million", "1 million")
    };

    i18n::interpolate(
        crate::menu_label(
            "settings.features.block_max_rows_warning",
...
impl FeaturesPageView {
        ...
        self.graphics_backend_dropdown.update(ctx, |dropdown, ctx| {
            if let Some(window) = ctx.windows().platform_window(ctx.window_id()) {
                let mut items = vec![DropdownItem::new(
                    crate::menu_label("settings.features.default", "Default"),
            ...
            dropdown.set_selected_by_name(
                gpu_settings
                    ...
                    .unwrap_or_else(|| crate::menu_label("settings.features.default", "Default")),
                ctx,
            );
        });
    }
    ...
    fn new_tab_placement_dropdown_item_label(val: NewTabPlacement) -> &'static str {
        match val {
            NewTabPlacement::AfterAllTabs => {
                crate::menu_label("settings.features.new_tab_after_all", "After all tabs")
            }
            NewTabPlacement::AfterCurrentTab => crate::menu_label(
                "settings.features.new_tab_after_current",
                "After current tab",
            ),
        }
    }
                ...
                Container::new(
                    Flex::row()
                        .with_child(
                            Container::new(
                                Text::new_inline(
                                    crate::menu_label("settings.features.width_pct", "Width %"),
                ...
                Container::new(
                    Flex::row()
                        .with_child(
                            Container::new(
                                Text::new_inline(
                                    crate::menu_label("settings.features.height_pct", "Height %"),
                                    appearance.ui_font_family(),
                                    appearance.ui_font_size(),
                                )
                                .with_color(theme.active_ui_text_color().into())
                ...
                .with_child(
                    appearance
                        ...
                        .span(crate::menu_label(
                            "settings.features.autohides_on_focus_loss",
            ...
            .with_child(
                Container::new(
                    Align::new(
                        Text::new_inline(
                            crate::menu_label(
                                "settings.features.command_longer_than",
            ...
            .with_child(
                Container::new(
                    Align::new(
                        Text::new_inline(
                            crate::menu_label(
                                "settings.features.seconds_to_complete",
                                "seconds to complete",
                            ),
                            appearance.ui_font_family(),
                            font_size,
            ...
            Flex::row()
                ...
                .with_child(
                    Shrinkable::new(
                        ...
                        Align::new(
                            Text::new_inline(
                                crate::menu_label("settings.features.keybinding", "Keybinding"),
                                appearance.ui_font_family(),
                                13.,
                            )
                    ...
                    Shrinkable::new(
                        ...
                        Align::new(if let Some(keybinding) = &keybinding.unsaved_binding {
                            ...
                            appearance
                                ...
                                .paragraph(
                                    crate::menu_label(
                                        "settings.features.click_to_set_hotkey",
                                        "Click to set global hotkey",
                                    )
                                    .to_string(),
                                )
                                .build()
    ...
    fn render_clicked<T: Fn(&mut EventContext, Keystroke) + 'static>(
        ...
        let save_button = Shrinkable::new(
            ...
            appearance
                ...
                .with_text_label(crate::menu_label("common.save", "Save").to_string())
                .build()
                .on_click(move |ctx, _, _| {
                        ...
                        .with_child(
                            Shrinkable::new(
                                ...
                                Align::new(
                                    Text::new_inline(
                                        crate::menu_label(
                                            "settings.features.press_new_shortcut",
        ...
        Hoverable::new(
            ...
            |state| {
                ...
                Container::new(
                    Text::new_inline(
                        crate::menu_label(
                            "settings.features.change_keybinding",
                            "Change keybinding",
                        ),
                        appearance.ui_font_family(),
                        12.,
...
fn init_display_count_dropdown(
    ...
    let no_preference = DropdownItem::new(
        crate::menu_label("settings.features.active_screen", "Active Screen"),
        //|| {
...
impl SettingsWidget for NativeRedirectWidget {
    ...
    fn render(
        ...
        render_body_item::<FeaturesPageAction>(
            crate::menu_label(
                "settings.features.open_links_desktop",
...
impl SettingsWidget for SessionRestorationWidget {
    ...
    fn render(
        ...
        let labeled_switch = render_body_item::<FeaturesPageAction>(
            crate::menu_label(
                "settings.features.restore_session",
                "Restore windows, tabs, and panes on startup",
            )
            .into(),
            Some(AdditionalInfo {
        ...
        if app.is_wayland() {
            ...
            let link = ui_builder
                .link(
                    crate::menu_label("settings.features.see_docs", "See docs.").to_owned(),
...
impl SettingsWidget for SnackbarHeaderWidget {
    ...
    fn render(
        ...
        render_body_item::<FeaturesPageAction>(
            crate::menu_label(
                "settings.features.sticky_command_header",
                "Show sticky command header",
            )
            .into(),
            Some(AdditionalInfo {
                mouse_state: self.additional_info_link.clone(),
...
impl SettingsWidget for LinkTooltipWidget {
    ...
    fn render(
        ...
        render_body_item::<FeaturesPageAction>(
            crate::menu_label(
                "settings.features.link_tooltip",
                "Show tooltip on click on links",
            )
            .into(),
            None,
...
impl SettingsWidget for QuitWarningModalWidget {
    ...
    fn render(
        ...
        render_body_item::<FeaturesPageAction>(
            crate::menu_label(
                "settings.features.quit_warning_modal",
...
impl SettingsWidget for LoginItemWidget {
    ...
    fn render(
        ...
        let ui_builder = appearance.ui_builder();
        #[cfg(target_os = "macos")]
        let label = crate::menu_label(
            "settings.features.start_at_login_macos",
            "Start Warp at login (requires macOS 13+)",
        );
        #[cfg(not(target_os = "macos"))]
        let label = crate::menu_label("settings.features.start_at_login", "Start Warp at login");
        render_body_item::<FeaturesPageAction>(
            label.into(),
            None,
            LocalOnlyIconState::for_setting(
...
impl SettingsWidget for QuitWhenAllWindowsClosedWidget {
    ...
    fn render(
        ...
        render_body_item::<FeaturesPageAction>(
            crate::menu_label(
                "settings.features.quit_when_closed",
...
impl SettingsWidget for ShowChangelogWidget {
    ...
    fn render(
        ...
        render_body_item::<FeaturesPageAction>(
            crate::menu_label(
                "settings.features.show_changelog",
...
impl SettingsWidget for MouseScrollMultiplierWidget {
    ...
    fn render(
            ...
            .with_children([
                ...
                if view.valid_mouse_scroll_multiplier {
                    ...
                    appearance
                        ...
                        .wrappable_text(
                            crate::menu_label(
                                "settings.features.allowed_values_1_20",
                                "Allowed Values: 1-20",
                            ),
                            true,
                        )
        ...
        render_body_item::<FeaturesPageAction>(
            crate::menu_label(
                "settings.features.mouse_scroll_lines",
            ...
            Some(AdditionalInfo {
                ...
                tooltip_override_text: Some(
                    crate::menu_label(
                        "settings.features.mouse_scroll_tooltip",
...
impl SettingsWidget for AutoOpenCodeReviewPaneWidget {
    ...
    fn render(
        ...
        let ui_builder = appearance.ui_builder();
        render_body_item::<FeaturesPageAction>(
            crate::menu_label("settings.features.auto_open_code_review", "Auto open code review panel").into(),
            None,
            LocalOnlyIconState::for_setting(
            ...
            ui_builder
                ...
                .finish(),
            Some(crate::menu_label("settings.features.auto_open_code_review_description", "When this setting is on, the code review panel will open on the first accepted diff of a conversation").into()),
        )
    }
}
    ...
    fn render(
        ...
        if default_terminal.is_warp_default() {
            ui_builder
                .wrappable_text(
                    crate::menu_label(
                        "settings.features.warp_is_default",
                        "Warp is the default terminal",
                    ),
                    true,
                )
                .with_style(UiComponentStyles {
...
impl SettingsWidget for BlockLimitWidget {
    ...
    fn render(
        ...
        render_body_item::<FeaturesPageAction>(
            crate::menu_label(
                "settings.features.max_block_rows",
                "Maximum rows in a block",
            )
            .into(),
            None,
            LocalOnlyIconState::for_setting(
...
impl SettingsWidget for DesktopNotificationsWidget {
    ...
    fn render(
        ...
        column.add_child(render_body_item::<FeaturesPageAction>(
            crate::menu_label(
                "settings.features.receive_desktop_notifications",
            ...
            let toggles = vec![
                view.render_notification_toggle(
                    session_settings
                        ...
                        .is_agent_task_completed_enabled,
                    crate::menu_label(
                        "settings.features.notify_agent_completes",
                ...
                view.render_notification_toggle(
                    ...
                    crate::menu_label(
                        "settings.features.notify_needs_attention",
                ...
                #[cfg(target_os = "macos")]
                {
                    view.render_notification_toggle(
                        ...
                        crate::menu_label(
                            "settings.features.play_notification_sounds",
        ...
        if FeatureFlag::HOANotifications.is_enabled() {
            ...
            column.add_child(render_body_item::<FeaturesPageAction>(
                crate::menu_label(
                    "settings.features.in_app_agent_notifications",
                    "Show in-app agent notifications",
                )
                .into(),
                None,
            ...
            if show_agent_notifications {
                ...
                let toast_duration_row = Flex::row()
                    ...
                    .with_child(
                        Text::new_inline(
                            crate::menu_label(
                                "settings.features.toast_visible_for",
                    ...
                    .with_child(
                        Text::new_inline(
                            crate::menu_label("settings.features.seconds", "seconds"),
                            appearance.ui_font_family(),
                            font_size,
                        )
                        .with_color(font_color.into())
        ...
        Flex::column()
            .with_children([
                render_sub_sub_header(
                    appearance,
                    crate::menu_label(
                        "settings.features.default_shell",
...
impl SettingsWidget for ConfirmCloseSharedSessionWidget {
    ...
    fn render(
        ...
        render_body_item::<FeaturesPageAction>(
            crate::menu_label(
                "settings.features.confirm_close_session",
...
impl SettingsWidget for GlobalHotkeyWidget {
    ...
    fn render(
        ...
        if app.is_wayland() {
            column.add_child(render_body_item::<FeaturesPageAction>(
                crate::menu_label("settings.features.global_hotkey", "Global hotkey:").to_owned(),
                None,
                ...
                Flex::row()
                    .with_children([
                        ui_builder
                            .span(crate::menu_label(
                                "settings.features.not_supported_wayland",
                        ...
                        ui_builder
                            .link(
                                crate::menu_label("settings.features.see_docs", "See docs.")
                                    .to_owned(),
                                Some(
            ...
            add_setting(
                ...
                || {
                    render_dropdown_item(
                        appearance,
                        crate::menu_label("settings.features.global_hotkey", "Global hotkey:"),
                        None,
                        None,
                        LocalOnlyIconState::for_setting(
...
impl SettingsWidget for AutocompleteSymbolsWidget {
    ...
    fn render(
        ...
        render_body_item::<FeaturesPageAction>(
            crate::menu_label(
                "settings.features.autocomplete_symbols",
                "Autocomplete quotes, parentheses, and brackets",
            )
            .into(),
            None,
        ...
        add_setting(
            ...
            || {
                render_dropdown_item(
                    appearance,
                    crate::menu_label(
                        "settings.features.code_editor_line_numbers",
...
impl SettingsWidget for ErrorUnderliningWidget {
    ...
    fn render(
        ...
        render_body_item::<FeaturesPageAction>(
            crate::menu_label(
                "settings.features.error_underlining",
                "Error underlining for commands",
            )
            .into(),
            None,
            LocalOnlyIconState::for_setting(
...
impl SettingsWidget for SyntaxHighlightingWidget {
    ...
    fn render(
        ...
        render_body_item::<FeaturesPageAction>(
            crate::menu_label(
                "settings.features.syntax_highlighting",
...
impl SettingsWidget for CompletionsMenuWhileTypingWidget {
    ...
    fn render(
        ...
        render_body_item::<FeaturesPageAction>(
            crate::menu_label(
                "settings.features.completions_while_typing",
...
impl SettingsWidget for CommandCorrectionsWidget {
    ...
    fn render(
        ...
        render_body_item::<FeaturesPageAction>(
            crate::menu_label(
                "settings.features.command_corrections",
                "Suggest corrected commands",
            )
            .into(),
            None,
            LocalOnlyIconState::for_setting(
...
impl SettingsWidget for AliasExpansionWidget {
    ...
    fn render(
        ...
        render_body_item::<FeaturesPageAction>(
            crate::menu_label(
                "settings.features.alias_expansion",
...
impl SettingsWidget for MiddleClickPasteWidget {
    ...
    fn render(
        ...
        render_body_item::<FeaturesPageAction>(
            crate::menu_label(
                "settings.features.middle_click_paste",
...
impl SettingsWidget for VimModeWidget {
    ...
    fn render(
        ...
        column.add_child(render_body_item::<FeaturesPageAction>(
            crate::menu_label(
                "settings.features.vim_keybindings",
        ...
        if vim_mode_enabled {
            ...
            let clipboard_setting = view.render_setting_subgroup_item(
                ...
                clipboard_switch,
                crate::menu_label(
                    "settings.features.vim_unnamed_register",
            ...
            let status_bar_setting = view.render_setting_subgroup_item(
                ...
                status_bar_switch,
                crate::menu_label("settings.features.vim_status_bar", "Show Vim status bar").into(),
            );
...
impl SettingsWidget for AtContextMenuInTerminalModeWidget {
    ...
    fn render(
        ...
        render_body_item::<FeaturesPageAction>(
            crate::menu_label(
                "settings.features.at_context_menu_terminal",
...
impl SettingsWidget for SlashCommandsInTerminalModeWidget {
    ...
    fn render(
        ...
        render_body_item::<FeaturesPageAction>(
            crate::menu_label(
                "settings.features.slash_commands_terminal",
...
impl SettingsWidget for OutlineCodebaseSymbolsForAtContextMenuWidget {
    ...
    fn render(
        ...
        render_body_item::<FeaturesPageAction>(
            crate::menu_label(
                "settings.features.outline_codebase_symbols",
...
impl SettingsWidget for ShowTerminalInputMessageLineWidget {
    ...
    fn render(
        ...
        render_body_item::<FeaturesPageAction>(
            crate::menu_label(
                "settings.features.terminal_input_message_line",
                "Show terminal input message line",
            )
            .into(),
            None,
            LocalOnlyIconState::for_setting(
...
impl SettingsWidget for PreserveInputFocusOnBlockSelectionWidget {
    ...
    fn render(
        ...
        render_body_item::<FeaturesPageAction>(
            crate::menu_label(
                "settings.features.preserve_input_focus_on_block_selection",
                "Preserve input focus on block selection",
            )
            .into(),
            None,
...
impl SettingsWidget for AutosuggestionKeybindingHintWidget {
    ...
    fn render(
        ...
        column.add_child(render_body_item::<FeaturesPageAction>(
            crate::menu_label(
                "settings.features.autosuggestion_hint",
...
impl SettingsWidget for AutosuggestionIgnoreButtonWidget {
    ...
    fn render(
        ...
        column.add_child(render_body_item::<FeaturesPageAction>(
            crate::menu_label(
                "settings.features.autosuggestion_ignore",
                "Show autosuggestion ignore button",
            )
            .into(),
            None,
            LocalOnlyIconState::for_setting(
    ...
    fn render_tab_behavior_setting_secondary_row(
        ...
        let other_keybinding_info = match *view.tab_behavior {
            TabBehavior::Completions if view.autosuggestions_keystroke.is_empty() => {
                ...
                Some(
                    crate::menu_label(
                        "settings.features.right_arrow_accepts",
            ...
            TabBehavior::Completions => Some(
                i18n::interpolate(
                    crate::menu_label(
                        "settings.features.accepts_autosuggestions",
                        "{} accepts autosuggestions.",
                    ),
                    &[("keystroke", view.autosuggestions_keystroke.to_string())],
                )
                .into_owned(),
            ),
            TabBehavior::Autosuggestions
                if *input_settings.completions_open_while_typing.value() =>
            {
                if view.completions_keystroke.is_empty() {
                    Some(
                        crate::menu_label(
                            "settings.features.completions_open_typing",
                            "Completions open as you type.",
                        )
                        .to_string(),
                    )
                } else {
                    Some(
                        i18n::interpolate(
                            crate::menu_label(
                                "settings.features.completions_open_typing_or",
                                "Completions open as you type (or {}).",
                            ),
                            &[("keystroke", view.completions_keystroke.to_string())],
                        )
                        .into_owned(),
                    )
                }
            ...
            TabBehavior::Autosuggestions if view.completions_keystroke.is_empty() => Some(
                crate::menu_label(
                    "settings.features.completions_unbound",
            ...
            TabBehavior::Autosuggestions => Some(
                i18n::interpolate(
                    crate::menu_label(
                        "settings.features.opens_completion_menu",
        ...
        let other_keybinding_name = match *view.tab_behavior {
            TabBehavior::Completions => Some(crate::menu_label(
                "settings.features.accept_autosuggestion",
                "Accept Autosuggestion",
            )),
            TabBehavior::Autosuggestions => Some(crate::menu_label(
                "settings.features.open_completions_menu",
        ...
        let mut tab_key_span = Flex::row()
            ...
            .with_child(
                appearance
                    .ui_builder()
                    .span(crate::menu_label(
                        "settings.features.tab_key_behavior",
                        "Tab key behavior",
                    ))
                    .with_style(UiComponentStyles {
    ...
    fn render(
        ...
        add_setting(
            ...
            || {
                render_dropdown_item(
                    appearance,
                    crate::menu_label("settings.features.ctrl_tab_behavior", "Ctrl+Tab behavior:"),
                    None,
                    None,
                    LocalOnlyIconState::for_setting(
...
impl SettingsWidget for MouseReportingWidget {
    ...
    fn render(
        ...
        let ui_builder = appearance.ui_builder();
        render_body_item::<FeaturesPageAction>(
            crate::menu_label("settings.features.mouse_reporting", "Enable Mouse Reporting").into(),
            Some(AdditionalInfo {
                mouse_state: self.additional_info_link.clone(),
                on_click_action: Some(FeaturesPageAction::OpenUrl(
...
impl SettingsWidget for ScrollReportingWidget {
    ...
    fn render(
        ...
        render_body_item::<FeaturesPageAction>(
            crate::menu_label(
                "settings.features.scroll_reporting",
...
impl SettingsWidget for FocusReportingWidget {
    ...
    fn render(
        ...
        render_body_item::<FeaturesPageAction>(
            crate::menu_label(
                "settings.features.focus_reporting",
...
impl SettingsWidget for AudibleBellWidget {
    ...
    fn render(
        ...
        render_body_item::<FeaturesPageAction>(
            crate::menu_label("settings.features.audible_bell", "Use Audible Bell").into(),
            None,
            LocalOnlyIconState::for_setting(
        ...
        Flex::column()
            .with_child(
                ui_builder
                    .label(
                        crate::menu_label(
                            "settings.features.word_char_allowlist",
...
impl SettingsWidget for SmartSelectWidget {
    ...
    fn render(
        ...
        column.add_child(render_body_item::<FeaturesPageAction>(
            crate::menu_label(
                "settings.features.smart_select",
...
impl SettingsWidget for ShowTerminalZeroStateBlockWidget {
    ...
    fn render(
        ...
        render_body_item::<FeaturesPageAction>(
            crate::menu_label(
                "settings.features.show_help_block",
...
impl SettingsWidget for CopyOnSelectWidget {
    ...
    fn render(
        ...
        render_body_item::<FeaturesPageAction>(
            crate::menu_label("settings.features.copy_on_select", "Copy on select").into(),
            None,
            LocalOnlyIconState::for_setting(
...
impl SettingsWidget for Osc52ClipboardAccessWidget {
    ...
    fn render(
        ...
        render_dropdown_item(
            appearance,
            crate::menu_label("settings.features.clipboard_osc52", "Clipboard access (OSC 52)"),
            Some(crate::menu_label("settings.features.clipboard_osc52_tooltip", "Controls whether programs running in the terminal can read or write your system clipboard.")),
            None,
            LocalOnlyIconState::for_setting(
...
impl SettingsWidget for NewTabPlacementWidget {
    ...
    fn render(
        ...
        render_dropdown_item(
            appearance,
            crate::menu_label("settings.features.new_tab_placement", "New tab placement"),
            None,
            None,
            LocalOnlyIconState::for_setting(
...
impl SettingsWidget for DefaultSessionModeWidget {
    ...
    fn render(
        ...
        let label = render_dropdown_item_label(
            crate::menu_label(
                "settings.features.default_session_mode",
...
impl SettingsWidget for WorkflowsInCommandSearch {
    ...
    fn render(
        ...
        render_body_item::<FeaturesPageAction>(
            crate::menu_label(
                "settings.features.global_workflows_search",
...
impl SettingsWidget for LinuxSelectionClipboardWidget {
    ...
    fn render(
        ...
        render_body_item::<FeaturesPageAction>(
            crate::menu_label(
                "settings.features.linux_selection_clipboard",
                "Honor linux selection clipboard",
            )
            .into(),
            Some(AdditionalInfo {
                mouse_state: self.additional_info_link.clone(),
                ...
                tooltip_override_text: Some(
                    crate::menu_label(
                        "settings.features.linux_clipboard_tooltip",
...
impl SettingsWidget for GPUWidget {
    ...
    fn render(
        ...
        let mut col = Flex::column().with_child(render_body_item::<FeaturesPageAction>(
            crate::menu_label(
                "settings.features.integrated_gpu",
            ...
            col.add_child(
                Container::new(
                    appearance
                        ...
                        .wrappable_text(
                            crate::menu_label(
                                "settings.features.changes_new_windows",
                                "Changes will apply to new windows.",
                            ),
                            true,
                        )
                        .with_style(UiComponentStyles {
...
impl SettingsWidget for WindowSystemWidget {
    ...
    fn render(
        ...
        children.add_child(render_body_item::<FeaturesPageAction>(
            crate::menu_label(
                "settings.features.wayland_window_management",
            ...
            Some(AdditionalInfo {
                ...
                tooltip_override_text: Some(
                    crate::menu_label(
                        "settings.features.wayland_tooltip",
        ...
        let mut secondary_text = crate::menu_label(
            "settings.features.wayland_description",
        ...
        if view.force_x11_changed {
            ...
            secondary_text.push_str(crate::menu_label(
                "settings.features.restart_for_changes",
...
impl SettingsWidget for GraphicsBackendWidget {
    ...
    fn render(
        ...
        let dropdown = render_dropdown_item(
            appearance,
            crate::menu_label(
                "settings.features.graphics_backend",
            ...
            col.add_child(
                appearance
                    ...
                    .wrappable_text(
                        i18n::interpolate(
                            crate::menu_label(
                                "settings.features.current_backend",
...
impl SettingsWidget for AsyncFindWidget {
    ...
    fn render(
        ...
        let label = render_body_item_label::<FeaturesPageAction>(
            crate::menu_label("settings.features.asynchronous_find", "Asynchronous find").into(),
            None,
            None,
            LocalOnlyIconState::for_setting(
        ...
        build_toggle_element(
            ...
            Some(
                crate::menu_label(
                    "settings.features.asynchronous_find_tooltip",
