...
fn default_font_label(is_ai_font: bool) -> String {
    let default_label = crate::menu_label("settings.appearance.default_label", "default");
    if is_ai_font {
        format!("{} ({})", AIFontName::default_value(), default_label)
    } else {
        format!("{} ({})", MonospaceFontName::default_value(), default_label)
    }
}
...
pub fn init_actions_from_parent_view<T: Action + Clone>(
    ...
    let mut toggle_binding_pairs = vec![
        ToggleSettingActionPair::new(
            crate::menu_label("settings.appearance.toggle.compact_mode", "compact mode"),
    ...
    toggle_binding_pairs.push(
        ToggleSettingActionPair::new(
            crate::menu_label("settings.appearance.toggle.cursor_blink", "cursor blink"),
            builder(SettingsAction::AppearancePageToggle(
    ...
    toggle_binding_pairs.push(
        ToggleSettingActionPair::new(
            crate::menu_label(
                "settings.appearance.toggle.jump_to_bottom_of_block_button",
    ...
    toggle_binding_pairs.push(ToggleSettingActionPair::new(
        crate::menu_label(
            "settings.appearance.toggle.dim_inactive_panes",
            "dim inactive panes",
        ),
        builder(SettingsAction::AppearancePageToggle(
    ...
    app.register_fixed_bindings(vec![FixedBinding::empty(
        crate::menu_label(
            "settings.appearance.binding.start_input_top",
            "Start Input at the Top",
        )
        .to_string(),
        builder(SettingsAction::AppearancePageToggle(
    ...
    app.register_fixed_bindings(vec![FixedBinding::empty(
        crate::menu_label(
            "settings.appearance.binding.pin_input_top",
            "Pin Input to the Top",
        )
        .to_string(),
        builder(SettingsAction::AppearancePageToggle(
            AppearancePageAction::SetInputMode {
    ...
    app.register_fixed_bindings(vec![FixedBinding::empty(
        crate::menu_label(
            "settings.appearance.binding.pin_input_bottom",
            "Pin Input to the Bottom",
        )
        .to_string(),
        builder(SettingsAction::AppearancePageToggle(
            AppearancePageAction::SetInputMode {
    ...
    app.register_fixed_bindings(vec![FixedBinding::empty(
        crate::menu_label(
            "settings.appearance.binding.toggle_input_mode",
            "Toggle Input Mode (Warp/Classic)",
        )
        .to_string(),
        builder(SettingsAction::AppearancePageToggle(
    ...
    toggle_binding_pairs.push(ToggleSettingActionPair::new(
        crate::menu_label(
            "settings.appearance.toggle.open_new_windows_custom_size",
    ...
    toggle_binding_pairs.push(ToggleSettingActionPair::new(
        crate::menu_label(
            "settings.appearance.toggle.window_blur_acrylic_texture",
    ...
    toggle_binding_pairs.push(ToggleSettingActionPair::new(
        crate::menu_label(
            "settings.appearance.toggle.tools_panel_visibility",
    ...
    toggle_binding_pairs.push(ToggleSettingActionPair::new(
        crate::menu_label(
            "settings.appearance.toggle.agent_font_match_terminal",
    ...
    toggle_binding_pairs.push(ToggleSettingActionPair::new(
        crate::menu_label(
            "settings.appearance.toggle.notebook_font_match_terminal",
        ...
        toggle_binding_pairs.push(
            ToggleSettingActionPair::custom(
                SettingActionPairDescriptions::new(
                    crate::menu_label(
                        "settings.appearance.toggle.show_code_review_button_in_tab_bar",
                        "Show code review button in tab bar",
                    ),
                    crate::menu_label(
                        "settings.appearance.toggle.hide_code_review_button_in_tab_bar",
    ...
    toggle_binding_pairs.push(
        ToggleSettingActionPair::new(
            crate::menu_label(
                "settings.appearance.toggle.focus_follows_mouse",
                "focus follows mouse",
            ),
            builder(SettingsAction::AppearancePageToggle(
    ...
    if FeatureFlag::FullScreenZenMode.is_enabled() {
        ...
        app.register_fixed_bindings([
            FixedBinding::empty(
                crate::menu_label(
                    "settings.appearance.binding.always_show_tab_bar",
                    "Always show tab bar",
                )
                .to_string(),
                builder(SettingsAction::AppearancePageToggle(
            ...
            FixedBinding::empty(
                crate::menu_label(
                    "settings.appearance.binding.hide_tab_bar_if_fullscreen",
                    "Hide tab bar if fullscreen",
                )
                .to_string(),
                builder(SettingsAction::AppearancePageToggle(
                    AppearancePageAction::SetWorkspaceDecorationVisibility(
            ...
            FixedBinding::empty(
                crate::menu_label(
                    "settings.appearance.binding.only_show_tab_bar_on_hover",
                    "Only show tab bar on hover",
                )
                .to_string(),
                builder(SettingsAction::AppearancePageToggle(
                    AppearancePageAction::SetWorkspaceDecorationVisibility(
        ...
        toggle_binding_pairs.push(
            ToggleSettingActionPair::new(
                crate::menu_label("settings.appearance.toggle.zen_mode", "zen mode"),
                builder(SettingsAction::AppearancePageToggle(
    ...
    if FeatureFlag::VerticalTabs.is_enabled() {
        toggle_binding_pairs.push(ToggleSettingActionPair::new(
            crate::menu_label(
                "settings.appearance.toggle.vertical_tab_layout",
                "vertical tab layout",
            ),
            builder(SettingsAction::AppearancePageToggle(
        ...
        toggle_binding_pairs.push(ToggleSettingActionPair::new(
            crate::menu_label(
                "settings.appearance.toggle.show_vertical_tabs_restored",
        ...
        toggle_binding_pairs.push(ToggleSettingActionPair::new(
            crate::menu_label(
                "settings.appearance.toggle.latest_prompt_conversation_title",
    ...
    if FeatureFlag::Ligatures.is_enabled() {
        toggle_binding_pairs.push(ToggleSettingActionPair::new(
            crate::menu_label(
                "settings.appearance.toggle.ligature_rendering",
                "ligature rendering",
            ),
            builder(SettingsAction::AppearancePageToggle(
    ...
    toggle_binding_pairs.push(ToggleSettingActionPair::new(
        crate::menu_label(
            "settings.appearance.toggle.preserve_active_tab_color",
    ...
    toggle_binding_pairs.push(ToggleSettingActionPair::new(
        crate::menu_label(
            "settings.appearance.toggle.custom_padding_alt_screen",
...
impl AppearanceSettingsPageView {
    ...
    fn build_page(ctx: &mut ViewContext<Self>) -> PageType<Self> {
        let mut categories = vec![Category::new(
            crate::menu_label("settings.appearance.category.themes", "Themes"),
            vec![
        ...
        if AppIconSettings::as_ref(ctx).is_supported_on_current_platform() {
            categories.push(Category::new(
                crate::menu_label("settings.appearance.category.icon", "Icon"),
        ...
        if !window_settings_widgets.is_empty() {
            categories.push(Category::new(
                crate::menu_label("settings.appearance.category.window", "Window"),
        ...
        categories.push(Category::new(
            crate::menu_label("settings.appearance.category.input", "Input"),
            category_widgets,
        ));

        categories.push(Category::new(
            crate::menu_label("settings.appearance.category.panes", "Panes"),
            vec![
        ...
        categories.push(Category::new(
            crate::menu_label("settings.appearance.category.blocks", "Blocks"),
        ...
        categories.push(Category::new(
            crate::menu_label("settings.appearance.category.text", "Text"),
            text_settings_widgets,
        ));

        categories.push(Category::new(
            crate::menu_label("settings.appearance.category.cursor", "Cursor"),
            vec![
        ...
        categories.push(Category::new(
            crate::menu_label("settings.appearance.category.tabs", "Tabs"),
    ...
    fn input_mode_dropdown_item_label(val: InputMode) -> &'static str {
        match val {
            InputMode::PinnedToBottom => crate::menu_label(
                "settings.appearance.dropdown.input_mode.pin_bottom_warp",
                "Pin to the bottom (Warp mode)",
            ),
            InputMode::PinnedToTop => crate::menu_label(
                "settings.appearance.dropdown.input_mode.pin_top_reverse",
                "Pin to the top (Reverse mode)",
            ),
            InputMode::Waterfall => crate::menu_label(
                "settings.appearance.dropdown.input_mode.start_top_classic",
    ...
    fn app_icon_dropdown_item_label(val: AppIcon) -> &'static str {
        match val {
            ...
            AppIcon::Classic2 => crate::menu_label(
                "settings.appearance.dropdown.app_icon.classic2",
                "Classic 2",
            ),
            AppIcon::Classic3 => crate::menu_label(
    ...
    fn thin_strokes_dropdown_item_label(val: ThinStrokes) -> &'static str {
        match val {
            ...
            ThinStrokes::OnHighDpiDisplays => crate::menu_label(
    ...
    fn enforce_minimum_contrast_dropdown_item_label(val: EnforceMinimumContrast) -> &'static str {
        match val {
            EnforceMinimumContrast::Always => crate::menu_label(
                "settings.appearance.dropdown.enforce_minimum_contrast.always",
                "Always",
            ),
            EnforceMinimumContrast::OnlyNamedColors => crate::menu_label(
                "settings.appearance.dropdown.enforce_minimum_contrast.only_named_colors",
                "Only for named colors",
            ),
            EnforceMinimumContrast::Never => crate::menu_label(
                "settings.appearance.dropdown.enforce_minimum_contrast.never",
                "Never",
            ),
        }
    }
    ...
    fn workspace_decoration_visibility_dropdown_item_label(
        ...
        match value {
            WorkspaceDecorationVisibility::AlwaysShow => crate::menu_label(
                "settings.appearance.dropdown.workspace_decoration_visibility.always",
                "Always",
            ),
            WorkspaceDecorationVisibility::HideFullscreen => crate::menu_label(
                "settings.appearance.dropdown.workspace_decoration_visibility.when_windowed",
                "When windowed",
            ),
            WorkspaceDecorationVisibility::OnHover => crate::menu_label(
                "settings.appearance.dropdown.workspace_decoration_visibility.only_on_hover",
                "Only on hover",
            ),
        }
    }
    ...
    fn tab_close_button_position_dropdown_item_label(
        ...
        match value {
            TabCloseButtonPosition::Right => crate::menu_label(
                "settings.appearance.dropdown.tab_close_button_position.right",
                "Right",
            ),
            TabCloseButtonPosition::Left => crate::menu_label(
                "settings.appearance.dropdown.tab_close_button_position.left",
                "Left",
            ),
        }
    }
    ...
    fn render(
        ...
        Align::new(
            appearance
                ...
                .link(
                    crate::menu_label(
                        "settings.appearance.create_custom_theme",
    ...
    fn render(
        ...
        Flex::column()
            ...
            .with_child(render_body_item::<AppearancePageAction>(
                crate::menu_label(
                    "settings.appearance.label.sync_with_os",
                    "Sync with OS",
                )
                .to_owned(),
                None,
            ...
            .with_child(
                appearance
                    ...
                    .span(
                        crate::menu_label(
                            "settings.appearance.label.sync_os_description",
...
impl SettingsWidget for CustomAppIconWidget {
    ...
    fn render(
        ...
        let dropdown = render_dropdown_item(
            appearance,
            crate::menu_label(
                "settings.appearance.label.customize_app_icon",
                "Customize your app icon",
            ),
            show_bundle_warning.then_some(crate::menu_label(
                "settings.appearance.label.app_icon_change_warning",
        ...
        let show_dock_icon_toggle = render_body_item::<AppearancePageAction>(
            crate::menu_label(
                "settings.appearance.label.show_warp_in_dock",
                "Show Warp in Dock",
            )
            .to_owned(),
            None,
                ...
                && app_icon_at_startup != AppIcon::Default
            {
                ...
                let column = Flex::column().with_child(dropdown).with_child(
                    appearance
                        ...
                        .wrappable_text(
                            crate::menu_label(
                                "settings.appearance.label.restart_for_icon_macos",
...
impl SettingsWidget for CustomWindowSizeWidget {
    ...
    fn render(
        ...
        let mut column = Flex::column().with_child(render_body_item::<AppearancePageAction>(
            crate::menu_label(
                "settings.appearance.label.open_new_windows_custom_size",
                "Open new windows with custom size",
            )
            .to_owned(),
            None,
        ...
        if *window_settings.open_windows_at_custom_size.value() {
            ...
            column.add_child(
                Container::new(render_body_item::<AppearancePageAction>(
                    crate::menu_label("settings.appearance.label.rows", "Rows").to_owned(),
                    None,
                    // We show the local-only icon for this with the toggle, not the individual inputs.
                    LocalOnlyIconState::Hidden,
                    ToggleState::Enabled,
    ...
    fn render(
            ...
            return Flex::column()
                .with_child(
                    Container::new(render_body_item_label::<AppearancePageAction>(
                        crate::menu_label(
                            "settings.appearance.label.window_opacity",
                            "Window Opacity:",
                        )
                        .to_owned(),
                        None,
                ...
                .with_child(
                    Container::new(
                        FormattedTextElement::from_str(
                            crate::menu_label(
                                "settings.appearance.label.transparency_not_supported",
        ...
        let mut col = Flex::column().with_child(render_body_item::<AppearancePageAction>(
            format!(
                "{} {}",
                crate::menu_label(
                    "settings.appearance.label.window_opacity_label",
                    "Window Opacity:"
                ),
                opacity_value
            ),
        ...
        if let Some(window) = app.windows().platform_window(view.window_id) {
            ...
            if !window.supports_transparency() && window.graphics_backend() != GraphicsBackend::Gl {
                let mut message: Cow<str> = Cow::Owned(crate::menu_label(
                    "settings.appearance.label.transparency_may_not_support",
                ...
                if (gpu_settings
                    ...
                    || gpu_settings
                        ...
                        .is_supported_on_current_platform()
                {
                    message.to_mut().push_str(crate::menu_label(
                        "settings.appearance.label.try_changing_graphics_backend",
        ...
        Flex::column()
            .with_child(render_body_item::<AppearancePageAction>(
                format!(
                    "{} {}",
                    crate::menu_label(
                        "settings.appearance.label.window_blur_radius_label",
                        "Window Blur Radius:"
                    ),
                    blur_value
                ),
...
impl SettingsWidget for WindowBlurTextureWidget {
    ...
    fn render(
        ...
        let mut col = Flex::column().with_child(render_body_item::<AppearancePageAction>(
            crate::menu_label(
                "settings.appearance.label.use_window_blur_acrylic",
            ...
            if !window.supports_transparency() && window.graphics_backend() != GraphicsBackend::Gl {
                col.add_child(
                    Container::new(
                        FormattedTextElement::from_str(
                            crate::menu_label(
                                "settings.appearance.label.transparency_hardware_may_not_support",
...
impl SettingsWidget for ToolsPanelStateScopeWidget {
    ...
    fn render(
        ...
        render_body_item::<AppearancePageAction>(
            crate::menu_label(
                "settings.appearance.label.tools_panel_visibility_across_tabs",
    ...
    fn render(
        ...
        let radio_buttons = appearance
            ...
            .radio_buttons(
                ...
                vec![
                    RadioButtonItem::text(crate::menu_label(
                        "settings.appearance.label.radio_warp",
                        "Warp",
                    )),
                    RadioButtonItem::text(crate::menu_label(
                        "settings.appearance.label.radio_shell_ps1",
                        "Shell (PS1)",
                    )),
                ],
        ...
        render_body_item::<AppearancePageAction>(
            crate::menu_label("settings.appearance.label.input_type", "Input type").to_owned(),
            None,
            LocalOnlyIconState::Hidden,
            ToggleState::Enabled,
            appearance,
...
impl SettingsWidget for InputModeWidget {
    ...
    fn render(
        ...
        render_dropdown_item(
            appearance,
            crate::menu_label("settings.appearance.label.input_position", "Input position"),
            None,
            None,
            LocalOnlyIconState::for_setting(
...
impl SettingsWidget for DimInactivePanesWidget {
    ...
    fn render(
        ...
        render_body_item::<AppearancePageAction>(
            crate::menu_label(
                "settings.appearance.label.dim_inactive_panes",
                "Dim inactive panes",
            )
            .to_owned(),
            None,
...
impl SettingsWidget for FocusFollowsMouseWidget {
    ...
    fn render(
        ...
        render_body_item::<AppearancePageAction>(
            crate::menu_label(
                "settings.appearance.label.focus_follows_mouse",
                "Focus follows mouse",
            )
            .to_owned(),
            None,
...
impl SettingsWidget for JumpToBottomOfBlockWidget {
    ...
    fn render(
        ...
        render_body_item::<AppearancePageAction>(
            crate::menu_label(
                "settings.appearance.label.show_jump_to_bottom_of_block",
...
impl SettingsWidget for ShowBlockDividersWidget {
    ...
    fn render(
        ...
        render_body_item::<AppearancePageAction>(
            crate::menu_label(
                "settings.appearance.label.show_block_dividers",
                "Show block dividers",
            )
            .to_owned(),
            None,
...
impl SettingsWidget for AIFontWidget {
    ...
    fn render(
        ...
        ai_font.add_child(render_body_item_label::<AppearancePageAction>(
            crate::menu_label("settings.appearance.label.agent_font", "Agent font").to_string(),
            None,
            None,
            LocalOnlyIconState::for_setting(
    ...
    fn render_line_height_editor(
        ...
        line_height.add_child(
            appearance
                .ui_builder()
                .label(
                    crate::menu_label("settings.appearance.label.line_height", "Line height")
                        .to_string(),
                )
                .with_style(UiComponentStyles {
                    margin: Some(Coords {
        ...
        line_height.add_child({
            let button = appearance
                ...
                .with_text_label(
                    crate::menu_label(
                        "settings.appearance.label.reset_to_default",
                        "Reset to default",
                    )
                    .to_string(),
                );
    ...
    fn render(
                    ...
                    .with_child(
                        Shrinkable::new(
                            ...
                            appearance
                                ...
                                .span(
                                    crate::menu_label(
                                        "settings.appearance.label.view_all_available_system_fonts",
        ...
        font_weight.add_child(
            appearance
                .ui_builder()
                .label(
                    crate::menu_label("settings.appearance.label.font_weight", "Font weight")
                        .to_string(),
                )
                .with_style(UiComponentStyles {
                    font_size: Some(CONTENT_FONT_SIZE),
                    ...
                    Shrinkable::new(
                        ...
                        Align::new(
                            appearance
                                ...
                                .span(
                                    crate::menu_label(
                                        "settings.appearance.label.notebook_font_size",
                                        "Notebook font size",
                                    )
                                    .to_string(),
                                )
...
impl SettingsWidget for MinimumContrastWidget {
    ...
    fn render(
        ...
        render_dropdown_item(
            appearance,
            crate::menu_label(
                "settings.appearance.label.enforce_minimum_contrast",
...
impl SettingsWidget for LigaturesWidget {
    ...
    fn render(
        ...
        render_body_item::<AppearancePageAction>(
            crate::menu_label(
                "settings.appearance.label.show_ligatures_in_terminal",
            ...
            Some(AdditionalInfo {
                ...
                tooltip_override_text: Some(
                    crate::menu_label(
                        "settings.appearance.label.ligatures_tooltip",
                        "Ligatures may reduce performance",
                    )
                    .to_string(),
                ),
            }),
...
impl SettingsWidget for CursorTypeWidget {
    ...
    fn render(
        ...
        render_body_item::<AppearancePageAction>(
            crate::menu_label("settings.appearance.label.cursor_type", "Cursor type").to_owned(),
            None,
            LocalOnlyIconState::for_setting(
                ...
                true => Flex::column()
                    .with_child(
                        appearance
                            ...
                            .span(
                                crate::menu_label(
                                    "settings.appearance.label.cursor_type_disabled_vim",
...
impl SettingsWidget for BlinkingCursorWidget {
    ...
    fn render(
        ...
        render_body_item::<AppearancePageAction>(
            crate::menu_label(
                "settings.appearance.label.blinking_cursor",
                "Blinking cursor",
            )
            .to_owned(),
            None,
...
impl SettingsWidget for TabCloseButtonPositionWidget {
    ...
    fn render(
        ...
        render_dropdown_item(
            appearance,
            crate::menu_label(
                "settings.appearance.label.tab_close_button_position",
...
impl SettingsWidget for TabIndicatorWidget {
    ...
    fn render(
        ...
        render_body_item::<AppearancePageAction>(
            crate::menu_label(
                "settings.appearance.label.show_tab_indicators",
                "Show tab indicators",
            )
            .to_owned(),
            None,
...
impl SettingsWidget for CodeReviewButtonWidget {
    ...
    fn render(
        ...
        render_body_item::<AppearancePageAction>(
            crate::menu_label(
                "settings.appearance.label.show_code_review_button",
...
impl SettingsWidget for PreserveActiveTabColorWidget {
    ...
    fn render(
        ...
        render_body_item::<AppearancePageAction>(
            crate::menu_label(
                "settings.appearance.label.preserve_active_tab_color",
                "Preserve active tab color for new tabs",
            )
            .to_owned(),
            None,
...
impl SettingsWidget for VerticalTabsWidget {
    ...
    fn render(
        ...
        render_body_item::<AppearancePageAction>(
            crate::menu_label(
                "settings.appearance.label.use_vertical_tab_layout",
...
impl SettingsWidget for ShowVerticalTabPanelInRestoredWindowsWidget {
    ...
    fn render(
        ...
        render_body_item::<AppearancePageAction>(
            crate::menu_label(
                "settings.appearance.label.show_vertical_tabs_restored",
                "Show vertical tabs panel in restored windows",
            )
            .to_owned(),
            None,
            ...
            Some(
                crate::menu_label(
                    "settings.appearance.label.vertical_tabs_restored_description",
...
impl SettingsWidget for HideTitleBarSearchBarInVerticalTabsWidget {
    ...
    fn render(
        ...
        render_body_item::<AppearancePageAction>(
            crate::menu_label(
                "settings.appearance.label.hide_search_bar_vertical_tabs",
                "Hide search bar in vertical tab layout",
            )
            .to_owned(),
            None,
            LocalOnlyIconState::for_setting(
            ...
            Some(
                crate::menu_label(
                    "settings.appearance.label.hide_search_bar_vertical_tabs_description",
...
impl SettingsWidget for UseLatestUserPromptAsConversationTitleInTabNamesWidget {
    ...
    fn render(
        ...
        render_body_item::<AppearancePageAction>(
            crate::menu_label(
                "settings.appearance.label.latest_prompt_conversation_title",
            ...
            Some(
                crate::menu_label(
                    "settings.appearance.label.latest_prompt_conversation_title_description",
...
impl SettingsWidget for EditToolbarWidget {
    ...
    fn render(
        ...
        let label = render_body_item_label::<AppearancePageAction>(
            crate::menu_label(
                "settings.appearance.label.header_toolbar_layout",
    ...
    fn render(
        ...
        let header_text = Flex::column()
            ...
            .with_child(
                Text::new(
                    crate::menu_label(
                        "settings.appearance.label.directory_tab_colors",
            ...
            .with_child(
                Text::new(
                    crate::menu_label(
                        "settings.appearance.label.directory_tab_colors_description",
        ...
        for (idx, (dir_path, current_color)) in directory_tab_colors(app).into_iter().enumerate() {
            ...
            for (ansi_id, mouse_state) in color_options.zip(dot_mouse_states.iter().cloned()) {
                ...
                let tooltip_text = match ansi_id {
                    None => crate::menu_label(
                        "settings.appearance.label.default_no_color_tooltip",
                        "Default (no color)",
                    )
                    .to_string(),
...
impl SettingsWidget for ZenModeWidget {
    ...
    fn render(
        ...
        render_dropdown_item(
            appearance,
            crate::menu_label(
                "settings.appearance.label.show_the_tab_bar",
                "Show the tab bar",
            ),
            None,
            None,
...
impl SettingsWidget for AltScreenPaddingWidget {
    ...
    fn render(
        ...
        let mut column = Flex::column().with_child(render_body_item::<AppearancePageAction>(
            crate::menu_label(
                "settings.appearance.label.use_custom_padding_alt_screen",
                ...
                .with_child(
                    Container::new(
                        Align::new(
                            Text::new(
                                crate::menu_label(
                                    "settings.appearance.label.uniform_padding_px",
                                    "Uniform padding (px)",
                                ),
                                appearance.ui_font_family(),
                                appearance.ui_font_size(),
...
impl SettingsWidget for ZoomLevelWidget {
    ...
    fn render(
        ...
        render_dropdown_item(
            appearance,
            crate::menu_label("settings.appearance.label.zoom", "Zoom"),
            Some(crate::menu_label(
                "settings.appearance.label.zoom_secondary",
